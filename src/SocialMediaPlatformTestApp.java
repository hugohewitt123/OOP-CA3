...
public class SocialMediaPlatformTestApp {
	...
	public static void main(String[] args) {
		...
		try {
            ...
            System.out.println("InvalidPostException thrown incorrectly");
		} catch (PostIDNotRecognisedException e) {
            System.out.println("PostIDNotRecognisedException thrown incorrectly");
		} catch (NotActionablePostException e) {
            System.out.println("NotActionablePostException thrown incorrectly");
		}
